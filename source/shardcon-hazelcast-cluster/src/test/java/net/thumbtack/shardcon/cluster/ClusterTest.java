...
import net.thumbtack.shardcon.common.TestUtil;
import net.thumbtack.shardcon.common.entity.Entity;
...
public class ClusterTest {
    ...
    private void testSelects() {
        ...
        for (int i = 0; i < steps; i++) {
            ...
            Assert.assertEquals(e, selected);
    ...
    public void init() {
        ...
        for (int i = 0; i < entitiesCount; i++) {
            entities.add(new Entity(TestUtil.generateUID(), randomString.nextString(), new Date()));
        }
        dao.insert(entities);
        entities.clear();
