 ...
 * 
 * @param <T> The type of object on which to operate.
 */
public interface Dao<T> extends Cacheable {
	/**
	 * Retrieves an object by primary key.
	 * 
	 * @param id Primary key of the object to fetch.
	 ...
	 * 
	 * @param entity Object to insert. Must be new and have no primary key. Its primary key will be set during insert.
	 ...
	 * @return <code>true</code> if instance updated, <code>false</code> otherwise.
	 */
